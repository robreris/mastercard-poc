...
resource "aws_ec2_transit_gateway_route_table" "tgwrt_secvpc" {
  depends_on         = [aws_ec2_transit_gateway.mstrcrd]
  transit_gateway_id = aws_ec2_transit_gateway.mstrcrd.id
  tags = {
    Name     = "tgw-rt-secvpc"
...
resource "aws_ec2_transit_gateway_vpc_attachment" "secvpc_att" {
  subnet_ids                                      = [var.secvpcaz1_sn_id, var.secvpcaz2_sn_id]
  transit_gateway_id                              = aws_ec2_transit_gateway.mstrcrd.id
...
resource "aws_ec2_transit_gateway_route" "cust1_to_secvpc" { 
  destination_cidr_block         = var.sec_vpc_cidr
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.secvpc_att.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.tgwrt_cust1.id
}
...
resource "aws_ec2_transit_gateway_route" "secvpc_to_cust1" {
  destination_cidr_block         = var.cust1_vpc_cidr
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.cust1_att.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.tgwrt_secvpc.id
}
...
resource "aws_ec2_transit_gateway_route_table_association" "secvpc" {
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_vpc_attachment.secvpc_att.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.tgwrt_secvpc.id
}
